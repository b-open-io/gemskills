...
// NOTE: Grok image/video generation was migrated from Replicate to the direct
// xAI API — see providers/xai.ts (xaiImage, xaiVideo). The old Replicate-Grok
// helpers were removed. callReplicateVeo above is retained for Veo-only
// features (reference images, last-frame interpolation).
